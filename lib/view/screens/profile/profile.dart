...
import 'package:docu_site/view/screens/profile/policies/privacy_policy.dart';
import 'package:docu_site/view/screens/profile/policies/terms_condition.dart';
...
import '../../../services/notification_state/push_toggle_services.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: StreamBuilder<bool>(
              stream: PushToggleService.enabledStream(),
              builder: (context, snap) {
                final enabled = snap.data ?? true; // default ON if not set
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final details = [
                      {'icon': Assets.imagesChangePassword, 'title': 'Change Password'},
                      {'icon': Assets.imagesLanguage, 'title': 'Language'},
                      {'icon': Assets.imagesEnableNotifications, 'title': 'Enable Notifications'},
                    ];
                      ...
                      trailing: index == 2
                        ...
                        child: Switch(
                          ...
                          onChanged: (v) async {
                            try {
                              if (v) {
                                await PushToggleService.enable();
                              } else {
                                await PushToggleService.disable();
                              }
                            } catch (e) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('Notifications: ${e.toString()}')),
                              );
                            }
                          },
                        ),
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                final details = [
                  {'icon': Assets.imagesHelpAndSupport, 'title': 'Help & Support'},
                  {'icon': Assets.imagesTermsConditions, 'title': 'Terms & Conditions'},
                      ...
                      case 3:
                        Get.bottomSheet(
                          CustomDialog(
                            ...
                            title: 'Logout?',
                            subTitle: 'Are you sure want to logout from this app?',
